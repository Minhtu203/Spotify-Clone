...
var HorizontalWrapper = styled(Wrapper)(_templateObject2$1 || (_templateObject2$1 = _taggedTemplateLiteral(["\n  height: 11px;\n  margin: -5px 0;\n  border-top: 5px solid rgba(255, 255, 255, 0);\n  border-bottom: 5px solid rgba(255, 255, 255, 0);\n  cursor: row-resize;\n  width: 100%;\n\n  :hover {\n    border-top: 5px solid rgba(0, 0, 0, 0.5);\n    border-bottom: 5px solid rgba(0, 0, 0, 0.5);\n  }\n\n  .disabled {\n    cursor: not-allowed;\n  }\n  .disabled:hover {\n    border-color: transparent;\n  }\n"])));
var VerticalWrapper = styled(Wrapper)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n  width: 11px;\n  margin: 0 -5px;\n  border-left: 5px solid rgba(255, 255, 255, 0);\n  border-right: 5px solid rgba(255, 255, 255, 0);\n  cursor: col-resize;\n\n  :hover {\n    border-left: 5px solid rgba(0, 0, 0, 0.5);\n    border-right: 5px solid rgba(0, 0, 0, 0.5);\n  }\n  .disabled {\n    cursor: not-allowed;\n  }\n  .disabled:hover {\n    border-color: transparent;\n  }\n"])));
...
var Resizer = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Resizer, [{
    ...
    value: function render() {
      ...
      return split === 'vertical' ? /*#__PURE__*/React.createElement(VerticalWrapper, props) : /*#__PURE__*/React.createElement(HorizontalWrapper, props);
    }
  }]);
...
var Pane = /*#__PURE__*/function (_PureComponent) {
  ...
  _createClass(Pane, [{
    ...
    value: function render() {
      ...
      var prefixedStyle = prefixAll(PaneStyle(this.props));
...
var ColumnStyle = styled.div(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  display: flex;\n  height: 100%;\n  flex-direction: column;\n  flex: 1;\n  outline: none;\n  overflow: hidden;\n  user-select: text;\n"])));
var RowStyle = styled.div(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n  display: flex;\n  height: 100%;\n  flex-direction: row;\n  flex: 1;\n  outline: none;\n  overflow: hidden;\n  user-select: text;\n"])));
  ...
  _createClass(SplitPane, [{
    ...
    value: function render() {
      ...
      var elements = notNullChildren.reduce(function (acc, child, idx) {
        ...
        if (isPane) {
          pane = /*#__PURE__*/cloneElement(child, paneProps);
        } else {
          pane = /*#__PURE__*/React.createElement(Pane, paneProps, child);
        }

        if (acc.length === 0) {
          return [].concat(_toConsumableArray(acc), [pane]);
        } else {
          var resizer = /*#__PURE__*/React.createElement(Resizer, {
            index: resizerIndex,
      ...
      return /*#__PURE__*/React.createElement(StyleComponent, {
        className: className,
        "data-type": "SplitPane",
        "data-split": split,
        ref: function ref(el) {
