export const SpotifyIcon = ({ className, width = '3.2rem', height = '3.2rem' }) => (
    <svg
        className={className}
        width={width}
        height={height}
        style={{ fill: 'currentcolor', color: 'var(--white)' }}
        role="img"
        viewBox="0 0 24 24"
        aria-label="Spotify"
        aria-hidden="false"
...
export const HomeIcon = ({ className, width = '2.6rem', height = '2.6rem' }) => (
    <svg
        className={className}
        width={width}
        height={height}
        style={{ fill: 'currentcolor', color: 'var(--white)', position: 'relative' }}
        data-encore-id="icon"
        role="img"
        aria-hidden="true"
        viewBox="0 0 24 24"
...
export const SearchIcon = ({ className, width = '2.4rem', height = '2.4rem', style }) => (
    <svg
        className={className}
        style={style}
        width={width}
...
export const ExpandIcon = ({ className, width = '1.6rem', height = '1.6rem' }) => (
    <svg
...
export const ListIcon = ({ className, width = '1.6rem', height = '1.6rem', style }) => (
    <svg
        style={style}
        className={className}
        width={width}
...
export const PinIcon = ({ className, width = '1.2rem', height = '1.2rem' }) => (
    <svg
...
export const RandomIcon = ({ className, width = '1.6rem', height = '1.6rem', style }) => (
    <svg
        width={width}
        height={height}
        className={className}
...
export const PrevIcon = ({ className, width = '1.6rem', height = '1.6rem', style }) => (
    <svg
        width={width}
        height={height}
        className={className}
...
export const NextIcon = ({ className, width = '1.6rem', height = '1.6rem', style }) => (
    <svg
        width={width}
        height={height}
        className={className}
...
export const RepeatIcon = ({ className, width = '1.6rem', height = '1.6rem', style }) => (
    <svg
        width={width}
        height={height}
        className={className}
...
export const PauseIcon = ({ style, className, width = '1.4rem', height = '1.4rem' }) => (
    <svg
        className={className}
        style={style}
        width={width}
...
export const NowPlayingIcon = ({ className, style, width = '1.6rem', height = '1.6rem' }) => (
    <svg
        className={className}
        style={style}
        width={width}
...
export const MicroIcon = ({ className, style, width = '1.6rem', height = '1.6rem' }) => (
    <svg
        className={className}
        style={style}
        width={width}
...
export const QueueIcon = ({ className, style, width = '1.6rem', height = '1.6rem' }) => (
    <svg
        className={className}
        style={style}
        width={width}
...
export const DeviceIcon = ({ className, style, width = '1.6rem', height = '1.6rem' }) => (
    <svg
        className={className}
        style={style}
        width={width}
...
export const VolumeIcon = ({ className, style, width = '1.6rem', height = '1.6rem' }) => (
    <svg
        className={className}
        style={style}
        width={width}
    ...
    >
        ...
        ></path>
        <path fill="currentColor" d="M11.5 13.614a5.752 5.752 0 0 0 0-11.228v1.55a4.252 4.252 0 0 1 0 8.127z"></path>
    </svg>
);

export const MuteVolumeIcon = ({ className, style, width = '1.6rem', height = '1.6rem' }) => (
    <svg
        className={className}
        style={style}
        width={width}
...
export const MiniPlayerIcon = ({ className, style, width = '1.6rem', height = '1.6rem' }) => (
    <svg
        className={className}
        style={style}
        width={width}
...
export const FullScreenIcon = ({ className, style, width = '1.6rem', height = '1.6rem' }) => (
    <svg
        className={className}
        style={style}
        width={width}
